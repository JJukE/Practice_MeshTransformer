...
import datetime
import torch
from torch.utils.tensorboard import SummaryWriter # jjuk_e
...
def run(args, train_dataloader, val_dataloader, METRO_model, smpl, mesh_sampler, renderer):
    wandb.init(project='metro_dq', entity='ray_park')
    smpl.eval()
    ...
    writer = SummaryWriter('tensorboard/') # jjuk_e
    ...
    wandb.watch(METRO_model, criterion_2d_keypoints, log='all')
    ...
    for iteration, (img_keys, images, annotations) in enumerate(train_dataloader):
        ...
        if iteration % iters_per_epoch == 0:
            ...
            #============================================================
            # (jjuk_e) for tensorboard
            #============================================================
            writer.add_scalar('mPVE/train', val_mPVE, epoch)
            writer.add_scalar('mPJPE/train', val_mPJPE, epoch)
            writer.add_scalar('PAmPJPE/train', val_PAmPJPE, epoch)

            wandb.log({'Epoch': epoch, 'mPVE': val_mPVE, 'mPJPE': val_mPJPE, 'PAmPJPE': val_PAmPJPE})
...
def main(args):
    ...
    if args.run_eval_only==True and args.resume_checkpoint!=None and args.resume_checkpoint!='None' and 'state_dict' not in args.resume_checkpoint:
        ...
        print('============================================================')
        print('Debug Process')
        print('checkpoint: ', args.resume_checkpoint)
        print('============================================================')
        print('============================================================')
